	...
	const puzzles = [
		{
			...
			question: "私は毎日姿を変え、満ちては欠け、また満ちる。しかし、決してその場所を動かない。私は何でしょう？",
			...
			hiddenMessage: "ひとときは輝き、<br>ときには姿を隠す。しかし、<br>みなを見守り続ける。",
			setup: function() {
				$gameContainer.html(`
                    <h2>${this.question}</h2>
					<br>
	...
	function displayCurrentPuzzle() {
		if (currentPuzzleIndex < puzzles.length) {
			...
			$gameContainer.html(`
                ...
                <p>邏�譎ｴ繧峨＠縺�ｼ√♀繧√〒縺ｨ縺�＃縺悶＞縺ｾ縺呻ｼ�</p>
				<button>ここからが本当の謎<butoon>
				`);
		}
	}
